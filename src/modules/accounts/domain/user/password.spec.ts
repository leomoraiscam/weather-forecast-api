...
describe('User password value object', () => {
  it('should be able to accept valid password', () => {
    const passwordOrError = Password.create('123456');

    expect(passwordOrError.isRight()).toBeTruthy();
  });

  it('should be able to reject password with less than 6 characters', () => {
    const passwordOrError = Password.create('12345');

    expect(passwordOrError.isLeft()).toBeTruthy();
  });

  it('should be able to reject password with more than 255 characters', () => {
  ...
  it('should not be able hash the password when already hashed', async () => {
